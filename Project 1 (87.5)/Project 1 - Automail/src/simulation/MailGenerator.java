...
public class MailGenerator {
    ...
    /**
     * Generates all mail items, sets their corresponding values and stores them in allMail
     */
     ...
     * So that the robot can now can pick up the mails from the pool.
     */
